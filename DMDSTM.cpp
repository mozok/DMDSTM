...
//Serial1.println("DMD.cpp line38");	//DEBUG
    uint16_t ui;
...
//Serial1.println("DMD.cpp line47");	//DEBUG
    ...
    // SPI.setClockDivider(SPI_CLOCK_DIV16);	// system clock / 4 = 4MHz SPI CLK to shift registers. If using a short cable, can put SPI_CLOCK_DIV2 here for 2x faster updates
...
//Serial1.println("DMD.cpp line54");	//DEBUG
...
//Serial1.println("DMD.cpp line61");	//DEBUG
...
//Serial1.println("DMD.cpp line68");	//DEBUG
    clearScreen(true);
//Serial1.println("DMD.cpp line70");	//DEBUG
    // init the scan line/ram pointer to the required start point
    bDMDByte = 0;
//Serial1.println("DMD.cpp line73");	//DEBUG
}
...
--------------------------------------------------------------------------------------*/
//int i = 0;
void DMD::scanDisplayBySPI(SPIClass SPI_2)
{
    ...
    //{
        ...
        for (int i=0;i<rowsize;i++) {
            SPI_2.transfer(bDMDScreenRAM[offset+i+row3]);
            SPI_2.transfer(bDMDScreenRAM[offset+i+row2]);
            SPI_2.transfer(bDMDScreenRAM[offset+i+row1]);
            SPI_2.transfer(bDMDScreenRAM[offset+i]);
        }
